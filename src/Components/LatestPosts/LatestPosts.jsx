...
const posts = [
    ...
    },
    {
        ...
        img: "https://elementor.zozothemes.com/restaurt/wp-content/uploads/sites/58/2019/04/r-blog-4-1-1-80x80.jpg",
        date: "April 19, 2022",
        border: true
    },
    {
        title: '4 Ways To Create Extra Space In Small Tables',
    ...
    return (
        <section className="mt-10 w-full p-[30px] bg-lightBg">
            <div className="relative">
                <h1 className="font-Themify text-[24px] font-semibold text-white">Latest Posts</h1>
