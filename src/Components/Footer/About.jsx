...
const About = () => {
    return (
        <section className="flex flex-col justify-start gap-5">
            ...
            <p className="text-muted text-justify text-[16px] leading-[30px]">Lorem ipsum dolor sit amet, elit. Aenean ligula eget dolor. Lorem ipsum dolor sit amet, consect to adipisicing elit. Ut enim ad minim veniam. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua, quis us elit aboris nisi.</p>
            <div className="flex justify-start items-center gap-3">
                <a href="#" className="p-2 bg-[#3b5999] text-white hover:bg-darkBg duration-300 group">
                    <BiLogoFacebook size={20} className="bg-[#3b5999] group-hover:bg-darkBg duration-300" />
                </a>
                <a href="#" className="p-2 bg-[#55acee] text-white hover:bg-darkBg duration-300 group">
