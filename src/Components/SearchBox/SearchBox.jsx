    ...
    return (
        <section className="w-full bg-lightBg md:p-[30px] rounded-none relative">
                <div className="relative">
                    <input type="text" className="w-full bg-darkBg text-white px-3 py-4 border  border-[#ffffff1a] outline-0 placeholder:text-[#b7b7b7] focus:border-btnBg duration-150" placeholder="Search for..."/>
